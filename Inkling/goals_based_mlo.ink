...
const number_of_iterations = 120
...
# reward total
## throughput for all machines
function maximize_output(state: SimState) {
    ...
    var reward_total = reward_machine0 + reward_machine1 + reward_machine2 + reward_machine3 + reward_machine4 + reward_machine5 + reward_machine6 + reward_machine7 + reward_machine8 + reward_machine9 + reward_machine10 + reward_machine11
...
graph (input: ObservationState): SimAction {
    ...
    concept optimize(input): SimAction {
        curriculum {
            ...
            goal (state: SimState, conceptaction: SimAction) {
                drive Throughput:
                    state.sink_throughput_absolute_sum
                    in Goal.RangeAbove(600000)

                minimize `Idle or Down`:
                    state.machines_state[0] == -1 and state.machines_state[0] == 0 and state.machines_state[1] == -1 and state.machines_state[1] == 0 and state.machines_state[2] == -1 and state.machines_state[2] == 0 and state.machines_state[3] == -1 and state.machines_state[3] == 0 and state.machines_state[4] == -1 and state.machines_state[4] == 0 and state.machines_state[5] == -1 and state.machines_state[5] == 0 and state.machines_state[6] == -1 and state.machines_state[6] == 0 and state.machines_state[7] == -1 and state.machines_state[7] == 0 and state.machines_state[8] == -1 and state.machines_state[8] == 0 and state.machines_state[9] == -1 and state.machines_state[9] == 0 and state.machines_state[10] == -1 and state.machines_state[10] == 0 and state.machines_state[11] == -1 and state.machines_state[11] == 0
                    in Goal.Range(-1, 1)

                maximize `Max Machine Speed 0`:
                    state.machines_actual_speed[0]
                    in Goal.Range(machine_min_speed[0], machine_max_speed[0])
                maximize `Max Machine Speed 1`:
                    state.machines_actual_speed[1]
                    in Goal.Range(machine_min_speed[1], machine_max_speed[1])
                maximize `Max Machine Speed 2`:
                    state.machines_actual_speed[2]
                    in Goal.Range(machine_min_speed[2], machine_max_speed[2])
                maximize `Max Machine Speed 3`:
                    state.machines_actual_speed[3]
                    in Goal.Range(machine_min_speed[3], machine_max_speed[3])
                maximize `Max Machine Speed 4`:
                    state.machines_actual_speed[4]
                    in Goal.Range(machine_min_speed[4], machine_max_speed[4])
                maximize `Max Machine Speed 5`:
                    state.machines_actual_speed[5]
                    in Goal.Range(machine_min_speed[5], machine_max_speed[5])
                maximize `Max Machine Speed 6`:
                    state.machines_actual_speed[6]
                    in Goal.Range(machine_min_speed[6], machine_max_speed[6])
                maximize `Max Machine Speed 7`:
                    state.machines_actual_speed[7]
                    in Goal.Range(machine_min_speed[7], machine_max_speed[7])
                maximize `Max Machine Speed 8`:
                    state.machines_actual_speed[8]
                    in Goal.Range(machine_min_speed[8], machine_max_speed[8])
                maximize `Max Machine Speed 9`:
                    state.machines_actual_speed[9]
                    in Goal.Range(machine_min_speed[9], machine_max_speed[9])
                maximize `Max Machine Speed 10`:
                    state.machines_actual_speed[10]
                    in Goal.Range(machine_min_speed[10], machine_max_speed[10])
                maximize `Max Machine Speed 11`:
                    state.machines_actual_speed[11]
                    in Goal.Range(machine_min_speed[11], machine_max_speed[11])
            ...
            lesson default {
                scenario {
                    ...
                    machine1_initial_speed: 40,
                    machine2_initial_speed: 70,
                    machine3_initial_speed: 50,
                    machine4_initial_speed: 90,
                    machine5_initial_speed: 90,
                    machine6_initial_speed: 110,
                    machine7_initial_speed: 40,
                    machine8_initial_speed: 70,
                    machine9_initial_speed: 50,
                    machine10_initial_speed: 90,
                    machine11_initial_speed: 90,
                    infeed_prox_upper_limit: infeed_prox_upper_limit,
                    infeed_prox_lower_limit: infeed_prox_lower_limit,
                    discharge_prox_upper_limit: discharge_prox_upper_limit,
                    discharge_prox_lower_limit: discharge_prox_lower_limit,
