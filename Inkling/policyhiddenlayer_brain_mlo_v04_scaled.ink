...
function machine11_output(state: SimState) {
    var machine11_throughput_scaled = (state.machines_actual_speed[11] 
    - machine_min_speed[11]) / (machine_max_speed[11] - machine_min_speed[11]) 
...
function Reward(state: SimState) {
    ...
    var reward_total = reward_machine0 + reward_machine1 + reward_machine2 
    + reward_machine3 + reward_machine4 + reward_machine5 +
    reward_machine6 + reward_machine7 + reward_machine8 
    + reward_machine9 + reward_machine10 + reward_machine11
    return reward_total
}
