...
# [AJ]: Comment the following because we want to only consider single line
# [AJ]: Two lines
...
# [AJ]: Comment the following becuase we only consider single line without the use of conveyors for load balancing between two lines
